...
public class PeliculaService {
    ...
    public void appReady(ApplicationReadyEvent event) {
        ...
        peliRepository.save(new Pelicula("Bohemian Rhapsody", Categoria.DRAMA, LocalDate.of(2018, 11, 12), "Una crónica de los años previos a la legendaria aparición de Queen en el concierto de Live Aid (1985).", "Bryan Singer", "Rami Malek, Gwilym Lee, Ben Hardy, Joseph Mazzello", "https://www.youtube.com/watch?v=pOYt7PmH_o8", "https://m.media-amazon.com/images/M/MV5BNDg2NjIxMDUyNF5BMl5BanBnXkFtZTgwMzEzNTE1NTM@._V1_SY1000_CR0,0,629,1000_AL_.jpg"));

        peliRepository.save(new Pelicula("Operación Overlord", Categoria.ACCION, LocalDate.of(2018, 11, 8), "Un pequeño grupo de soldados estadounidenses encuentra horror detrás de las líneas enemigas en la víspera del Día D.", "Julius Avery", "Jovan Adepo, Wyatt Russell, Mathilde Ollivier", "https://www.youtube.com/watch?v=oAgsgbh-32s", "https://m.media-amazon.com/images/M/MV5BNzU0NTI1MTU2M15BMl5BanBnXkFtZTgwNTg4MDIzNjM@._V1_SY1000_CR0,0,639,1000_AL_.jpg"));

        peliRepository.save(new Pelicula("Nace una estrella", Categoria.DRAMA, LocalDate.of(2018, 11, 1), "Un músico ayuda a un joven cantante a encontrar la fama, incluso cuando la edad y el alcoholismo envían a su propia carrera a una espiral descendente.", "Bradley Cooper", "Lady Gaga, Bradley Cooper, Sam Elliott", "https://www.youtube.com/watch?v=nSbzyEJ8X9E", "https://m.media-amazon.com/images/M/MV5BMjE3MDQ0MTA3M15BMl5BanBnXkFtZTgwMDMwNDY2NTM@._V1_SY1000_CR0,0,674,1000_AL_.jpg"));
