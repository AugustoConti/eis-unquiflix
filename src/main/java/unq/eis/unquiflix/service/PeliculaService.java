...
public class PeliculaService {
    ...
    public List<Pelicula> getTop10Peliculas() {
        ...
        peliRepository.findAll().forEach(pelis::add);
        pelis.sort((p1, p2) -> p1.getRanking() > p2.getRanking() ? -1 : (p1.getRanking() < p2.getRanking()) ? 1 : 0);
        return pelis.stream().limit(10).collect(Collectors.toList());
    }
